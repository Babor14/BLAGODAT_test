...
public partial class BlagodateContext : DbContext
{
    public BlagodateContext()
    {
    }

    public BlagodateContext(DbContextOptions<BlagodateContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=TEACHERPC;Initial Catalog=BLAGODATE;Persist Security Info=True;User ID=user17;Password=1234;Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ClientsImport>(entity =>
        {
            entity.HasKey(e => e.КодКлиента).HasName("PK__Clients___FDED6CB1743421EB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Order_im__3214EC278B05E8E3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Services__3214EC2787F2303A");
        ...
        {
            entity.HasKey(e => e.КодСотрудника).HasName("PK__Workers___6B9F1565F3656105");
